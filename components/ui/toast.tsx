...
function getToastClasses(variant: ToastVariant = "default"): string {
  return cn(
    toastBaseClasses,
    toastVariantClasses[variant] ?? toastVariantClasses.default
  );
}
